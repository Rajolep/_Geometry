...
\node (A) at (6.05, 5.63)[point,label=above :$A$] {};
\node (D) at (0,0)[point,label=left :$D$] {};
\node (C) at (4,0)[point,label=below :$C$] {};
\node (B) at (2.05,5.63)[point,label=above :$B$] {};
\node (E) at (2.47,4.40)[point,label=left :$E$] {};
\node (F) at (3.57,1.23)[point,label=right :$F$] {};
\node (O) at (3.02,2.75)[point,label=left :$O$] {};
\draw (D)--(C);
\draw (D)--(A);
\draw (A)--(B);
\draw (C)--(A);
